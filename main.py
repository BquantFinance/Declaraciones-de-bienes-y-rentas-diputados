        ...
        if filtered_names:
            ...
            with st.container(border=True):
                ...
                with right_col:
                    ...
                    info_text = f"""
                    <p style='margin-bottom: 8px;'>📍 <b>Circunscripción:</b> {person_data['Circunscripción']}</p>
                    <p style='margin-bottom: 8px;'>🏛️ <b>Cargo:</b> {person_data['Cargo']}</p>
                    """
                    ...
                    info_text += f"<p style='margin-bottom: 8px;'>💑 <b>Estado Civil:</b> {estado_civil}</p>"
