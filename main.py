        ...
        if not comparison_mode:
            ...
            if names:
                ...
                if selected_name:
                    ...
                    # Financial Information Section - Beautiful Cards
                    st.markdown("""
                    <h2 style="color: white; margin: 30px 0 25px 0; font-size: 1.8rem; font-weight: 800;">
                        💰 Información Financiera
                    </h2>
                    """, unsafe_allow_html=True)
                    
                    # Financial metrics in elegant cards
                    col1, col2, col3, col4 = st.columns(4)
                    
                    with col1:
                        st.markdown(f"""
                        <div style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.15), rgba(118, 75, 162, 0.15)); 
                                    border-radius: 15px; padding: 20px; text-align: center; min-height: 120px;
                                    border: 1px solid rgba(102, 126, 234, 0.2); transition: all 0.3s ease;">
                            <p style="color: rgba(255, 255, 255, 0.7); font-size: 0.75rem; text-transform: uppercase; 
                                      letter-spacing: 1px; margin-bottom: 10px;">INGRESOS DECLARADOS</p>
                            <p style="color: #667eea; font-size: 1.5rem; font-weight: bold; margin: 0;">
                    ...
                    with col2:
                        ...
                        <div style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.15), rgba(118, 75, 162, 0.15)); 
                                    ...
                                    border: 1px solid rgba(102, 126, 234, 0.2); transition: all 0.3s ease;">
                            <p style="color: rgba(255, 255, 255, 0.7); font-size: 0.75rem; text-transform: uppercase; 
                                      letter-spacing: 1px; margin-bottom: 10px;">ACTIVOS LÍQUIDOS</p>
                            <p style="color: #667eea; font-size: 1.5rem; font-weight: bold; margin: 0;">
                    ...
                    with col3:
                        ...
                        <div style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.15), rgba(118, 75, 162, 0.15)); 
                                    ...
                                    border: 1px solid rgba(102, 126, 234, 0.2); transition: all 0.3s ease;">
                            <p style="color: rgba(255, 255, 255, 0.7); font-size: 0.75rem; text-transform: uppercase; 
                                      letter-spacing: 1px; margin-bottom: 10px;">DEUDAS</p>
                            <p style="color: #667eea; font-size: 1.5rem; font-weight: bold; margin: 0;">
                    ...
                    with col4:
                        ...
                        st.markdown(f"""
                        <div style="background: linear-gradient(135deg, {'rgba(76, 175, 80, 0.15)' if net_position >= 0 else 'rgba(244, 67, 54, 0.15)'}, 
                                    {'rgba(76, 175, 80, 0.25)' if net_position >= 0 else 'rgba(244, 67, 54, 0.25)'}); 
                                    border-radius: 15px; padding: 20px; text-align: center; min-height: 120px;
                                    border: 1px solid {color}40; transition: all 0.3s ease;">
                            <p style="color: rgba(255, 255, 255, 0.7); font-size: 0.75rem; text-transform: uppercase; 
                                      letter-spacing: 1px; margin-bottom: 10px;">POSICIÓN NETA</p>
                            <p style="color: {color}; font-size: 1.5rem; font-weight: bold; margin: 0;">
                                €{net_position:,.0f}
                            </p>
                        </div>
                        """, unsafe_allow_html=True)
                    ...
                    # Patrimony Section
                    st.markdown("""
                    <h2 style="color: white; margin: 40px 0 25px 0; font-size: 1.8rem; font-weight: 800;">
                        🏠 Patrimonio
                    </h2>
                    """, unsafe_allow_html=True)
                    ...
                    with col1:
                        st.markdown(f"""
                        <div style="background: linear-gradient(135deg, rgba(255, 193, 7, 0.15), rgba(255, 152, 0, 0.15)); 
                                    border-radius: 15px; padding: 20px; text-align: center; min-height: 120px;
                                    border: 1px solid rgba(255, 193, 7, 0.3); transition: all 0.3s ease;">
                            <p style="color: rgba(255, 255, 255, 0.7); font-size: 0.75rem; text-transform: uppercase; 
                                      letter-spacing: 1px; margin-bottom: 10px;">IRPF PAGADO</p>
                            <p style="color: #ffa500; font-size: 1.5rem; font-weight: bold; margin: 0;">
                    ...
                    with col2:
                        ...
                        <div style="background: linear-gradient(135deg, rgba(255, 193, 7, 0.15), rgba(255, 152, 0, 0.15)); 
                                    ...
                                    border: 1px solid rgba(255, 193, 7, 0.3); transition: all 0.3s ease;">
                            <p style="color: rgba(255, 255, 255, 0.7); font-size: 0.75rem; text-transform: uppercase; 
                                      letter-spacing: 1px; margin-bottom: 10px;">PROPIEDADES URBANAS</p>
                            <p style="color: #ffa500; font-size: 1.5rem; font-weight: bold; margin: 0;">
                    ...
                    with col3:
                        ...
                        <div style="background: linear-gradient(135deg, rgba(255, 193, 7, 0.15), rgba(255, 152, 0, 0.15)); 
                                    ...
                                    border: 1px solid rgba(255, 193, 7, 0.3); transition: all 0.3s ease;">
                            <p style="color: rgba(255, 255, 255, 0.7); font-size: 0.75rem; text-transform: uppercase; 
                                      letter-spacing: 1px; margin-bottom: 10px;">PROPIEDADES RÚSTICAS</p>
                            <p style="color: #ffa500; font-size: 1.5rem; font-weight: bold; margin: 0;">
                    ...
                    with col4:
                        ...
                        <div style="background: linear-gradient(135deg, rgba(255, 193, 7, 0.15), rgba(255, 152, 0, 0.15)); 
                                    ...
                                    border: 1px solid rgba(255, 193, 7, 0.3); transition: all 0.3s ease;">
                            <p style="color: rgba(255, 255, 255, 0.7); font-size: 0.75rem; text-transform: uppercase; 
                                      letter-spacing: 1px; margin-bottom: 10px;">VEHÍCULOS</p>
                            <p style="color: #ffa500; font-size: 1.5rem; font-weight: bold; margin: 0;">
